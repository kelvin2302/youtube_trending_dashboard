...
def get_video_categories(region_code="NZ"):
...
def get_trending_videos(region_code="NZ", max_results=20):  # Update max_results to 20
...
trending_videos = get_trending_videos(region_code="NZ", max_results=20)  # Request 20 trending videos
...
# Save to CSV
df.to_csv("YouTube_Trending_Videos_NewZealand.csv", index=False)
